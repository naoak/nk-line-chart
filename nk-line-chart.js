...
export class NkLineChartElement extends LegacyElementMixin(PolymerElement) {
  static get is() {
    return 'nk-line-chart';
  }
  ...
  _computeTransformer(origin, chartArea) {
  ...
  _drawBackgroundRect(rect, chartArea, attrs) {
  ...
  _drawCircle(circle, point, attrs) {
  ...
  _drawPath(path, startPoint, moves, attrs) {
  ...
  _drawLabelAtAxis(text, point, labelOpt, pointValueName) {
    var option = labelOpt;
  ...
  _drawLabelAtPoint(text, point, index) {
  ...
  _paramsChanged(backgroundRectStyle, chartArea_, origin, pathStyle, point, pointLabel_, rows, xAxis_, xRange, yAxis_, yRange) {
...
window.customElements.define(NkLineChartElement.is, NkLineChartElement);
